          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(song.title,
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700,
                color: isPlaying ? accent : const Color(0xFFEEEEFF)),
              maxLines: 1, overflow: TextOverflow.ellipsis),
            const SizedBox(height: 2),
            Text('${song.artist}${song.album.isNotEmpty ? ' · ${song.album}' : ''}',
              style: const TextStyle(fontSize: 11.5, color: Color(0xFF6060A0)),
              maxLines: 1, overflow: TextOverflow.ellipsis),
          ])),
          ...
          GestureDetector(
            ...
            child: Padding(
              ...
              child: Icon(
                ...
                color: song.isLiked ? accent : const Color(0xFF6060A0),
                size: 18),
            ),
          ),
        ]),
