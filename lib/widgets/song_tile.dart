...
class SongTile extends StatelessWidget {
      ...
      child: Padding(
        ...
        child: Row(children: [
          ClipRRect(
            ...
            child: SizedBox(
              ...
              child: Stack(children: [
                ...
                if (isPlaying) Center(child: Icon(
                  engine.isPlaying ? Icons.equalizer_rounded : Icons.pause_rounded,
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text('${song.artist}${song.album.isNotEmpty ? ' · ${song.album}' : ''}', style: const TextStyle(fontSize: 11.5, color: Color(0xFF6060A0)), maxLines: 1, overflow: TextOverflow.ellipsis),
          ])),
          Text(song.durationFormatted, style: const TextStyle(fontSize: 11, color: Color(0xFF6060A0))),
          ...
          GestureDetector(
            ...
            child: Padding(
              ...
              child: Icon(song.isLiked ? Icons.favorite_rounded : Icons.favorite_border_rounded, color: song.isLiked ? accent : const Color(0xFF6060A0), size: 18),
            ),
          ),
        ]),
      ),
  ...
  Widget _buildThumb(String? url, bool isPlaying) {
    if (song.sourceStr == 'local') {
      return QueryArtworkWidget(
        id: int.parse(song.id),
        type: ArtworkType.AUDIO,
        nullArtworkWidget: _defaultThumb(),
        artworkBorder: BorderRadius.zero,
      );
    }
    if (url != null) {
      return CachedNetworkImage(imageUrl: url, fit: BoxFit.cover, errorWidget: (_, __, ___) => _defaultThumb());
    }
