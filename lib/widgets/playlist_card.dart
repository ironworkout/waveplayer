      ...
      child: GestureDetector(
        onTap: () {
            ...
            if (allSongs.isNotEmpty) {
                context.read<AudioEngine>().playLocal(allSongs.first, newQueue: allSongs);
        ...
        child: Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ClipRRect(
              ...
              child: SizedBox(width: double.infinity, height: 90, child: Center(child: Text('🎵', style: TextStyle(fontSize: 40)))),
            ),
            Padding(
              padding: const EdgeInsets.all(10),
              child: Text(playlist.name, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold), maxLines: 1),
            ),
          ]),
        ),
      ),
